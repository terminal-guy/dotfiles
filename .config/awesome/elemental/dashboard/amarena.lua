...
local petal_top_left = create_url_petal("GH", x.color4, x.color12, "https://github.com/terminal-guy", true, true, false, true)
local petal_top_right = create_url_petal("YT", x.color1, x.color9, "https://youtube.com/", true, true, true, false)
local petal_bottom_right = create_url_petal("DT", x.color2, x.color10, "https://github.com/terminal-guy/dotfiles",false, true, true, true)
